...
import static com.android.settings.deviceinfo.firmwareversion.CustomVersionPreferenceController.CUSTOM_PROP;
...
public class FirmwareVersionPreferenceController extends BasePreferenceController {
    ...
    public CharSequence getSummary() {
        ...
        final String romVersion = SystemProperties.get(CUSTOM_PROP, versionDef);
